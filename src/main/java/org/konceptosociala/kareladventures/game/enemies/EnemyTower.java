...
public class EnemyTower extends Node implements IUpdatable, IAmEnemy {
    ...
    private void shoot() {
        Bullet bullet =  new Bullet(this.getOriginPosition().add(0,5,0),thisGameState.getPlayer().getCharacterControl().getPhysicsLocation().add(0,-1,0),assetManager,bulletAppState);
